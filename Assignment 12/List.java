...
//  package com.deitel.datastructures;
  ...
  public class List<E> {
     ...
     public E search(E value){
       // In cases where the list is empty, it's certain it wont have the value sought
       if(isEmpty())
        return null;
        
       // we'll use this as our iterator, over each node in the list
       ListNode<E> current = firstNode;
        
       // Loop as long as there are more nodes to loop over
